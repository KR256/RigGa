...
import resampleCurvesCommandFunctionality
...
kPluginCmdName = "resampleCurvesCommand"
...
def cmdCreator():
    ...
    return resampleCurvesCommandFunctionality.Main()
...
def syntaxCreator():
    ...
    syntax.addFlag(noiseOrDenoiseShort, noiseOrDenoiseLong, om.MSyntax.kString)
